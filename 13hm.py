...
def show_intro():
    show_hco_ascii()
    cprint("╔══════════════════════════════════════════════════════╗", "red")
    cprint("║                HAVEES PROJECT CODE.           ║", "red")
    cprint("║                    TOOLS PELACAK                     ║", "red")
    cprint("║                   Author - 13halana                  ║", "red")
    cprint("╚══════════════════════════════════════════════════════╝", "red")
    time.sleep(1)

# Show warning + open YT
def show_warning():
    cprint("\n[!] WARNING: VOGARD TEAM ", "yellow", attrs=["bold"])
    time.sleep(2)
    os.system("xdg-open https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=tirm6ws")
    time.sleep(5)
